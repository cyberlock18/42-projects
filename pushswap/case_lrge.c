...
/*   Updated: 2024/12/21 21:42:14 by ruortiz-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void push_to_b(t_node **stack_a, t_node **stack_b, int *size_a, int *size_b)
{
    int range;
...
static void push_to_a(t_node **stack_a, t_node **stack_b, int *size_a, int *size_b)
{
    while (*size_b > 0)
    {
